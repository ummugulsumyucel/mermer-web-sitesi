                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcumb-content">
                            <h1 class="breadcumb-title">Ürün Detayları</h1>
                ...
                <div class="shop-details bg-white">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-12">
<?php
// 1. Nitelik isimlerini çek
$nitelikler_sql = "SELECT nitelik_id, nitelik_adi FROM nitelikler";
...
try {
    ...
    if(is_array($urun_nitelikleri)) {
        foreach($urun_nitelikleri as $nitelik_id => $deger) {
            if(isset($nitelik_isimleri[$nitelik_id]) && !empty($deger)) {
                $nitelik_display[$nitelik_isimleri[$nitelik_id]] = $deger;
            }
        }
    }

    // 3. Başlık ve şık HTML kutucuklarla göster
    echo "<h3 style='color:#34495e; margin-bottom:10px; margin-top:10px;'>Ürün Nitelikleri</h3>";
    ...
    if(!empty($nitelik_display)) {
        ...
        echo "<p>Ürüne ait nitelik bulunamadı.</p>";
    }
...
?>
    ...
    <div class="form-title">
        <h3 class="inner-title">İletişim</h3>
        <p style="margin: 10px;">Gizliliğiniz bizim için önemlidir. Zorunlu alanlar * ile işaretlenmiştir.</p>
    </div>
     <!-- Başarı/Hata mesajı burada görünecek -->
    <?php echo $message; ?>
    
   <form method="POST" action="">
    <div class="row">
        <div class="col-md-6 form-group style-white2">
            <input type="text" name="isim" placeholder="İsminiz *" class="form-control" required>
        ...
        <div class="col-12 form-group style-white2">
            <textarea name="mesaj" placeholder="Mesajınızı Yazın *" class="form-control" rows="5" required></textarea>
            <i class="text-title far fa-pencil-alt"></i>
        </div>

        <div class="col-12 form-group mb-0">
            <button type="submit" name="submit" class="btn-wrapper theme-btn style3" style="max-width: 300px;">GÖNDER</button>
        </div>
    </div>
</form>
</div>
